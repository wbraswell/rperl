...
# [[[ OUTPUT OBJECT FILE, DOES NOT STATICALLY LINK TO libperl.a, DOES NOT REQUIRE libperl-dev ]]]
...
# [[[ OUTPUT OBJECT FILE, DOES NOT DYNAMICALLY LINK TO libperl.so, DOES NOT REQUIRE libperl-dev ]]]
