...
#    RPerl::diag "in 05_type_array.t, top of for() loop, have \$mode_id = $mode_id\n";
    ...
    foreach my string $type (
        qw(integer number string array))
    {
        lives_and(
            sub {
    ...
    throws_ok(    # TIVAVRV30
        ...
        "/(EIVAVRV00.*$mode_tagline)|(Usage.*integer__array_ref__typetest0)/", # DEV NOTE: 2 different error messages, RPerl & C
    ...
    throws_ok(    # TNVAVRV30
        ...
        "/(ENVAVRV00.*$mode_tagline)|(Usage.*number__array_ref__typetest0)/", # DEV NOTE: 2 different error messages, RPerl & C
    ...
    throws_ok(    # TPVAVRV30
        ...
        "/(EPVAVRV00.*$mode_tagline)|(Usage.*string__array_ref__typetest0)/", # DEV NOTE: 2 different error messages, RPerl & C
