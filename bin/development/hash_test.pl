...
print STDERR q{in hash_test.pl, have integer__ops() = '} . integer__ops() . "'\n" or croak();
print STDERR q{in hash_test.pl, have integer__types() = '} . integer__types() . "'\n" or croak();
print STDERR q{in hash_test.pl, have number__ops() = '} . number__ops() . "'\n" or croak();
print STDERR q{in hash_test.pl, have number__types() = '} . number__types() . "'\n" or croak();
print STDERR q{in hash_test.pl, have string__ops() = '} . string__ops() . "'\n" or croak();
print STDERR q{in hash_test.pl, have string__types() = '} . string__types() . "'\n" or croak();
print STDERR q{in hash_test.pl, have hash__ops() = '} . hash__ops() . "'\n" or croak();
print STDERR q{in hash_test.pl, have hash__types() = '} . hash__types() . "'\n" or croak();
...
for my integer $i ( 0 .. $i_MAX ) {
	print STDERR "in hash_test.pl, top of for() loop $i/$i_MAX\n" or croak();
...
#	print STDERR "in hash_test.pl $i/$i_MAX, have \$retval_stringify =\n$retval_stringify\n" or croak();
...
#	print STDERR "in hash_test.pl $i/$i_MAX, have \$retval_integer__hash_ref = \n" . Dumper($retval_integer__hash_ref) . "\n" or croak();
...
#	print STDERR "in hash_test.pl $i/$i_MAX, have \$retval_number__hash_ref = \n" . Dumper($retval_number__hash_ref) . "\n" or croak();
...
#	print STDERR "in hash_test.pl, have \$my_peeps =\n" . RPerl::DUMPER($my_peeps) . "\n" or croak();
...
#	print STDERR "in hash_test.pl, have \$retval_jeffys =\n" . RPerl::DUMPER($retval_jeffys) . "\n" or croak();
