...
#print STDERR q{in inline_cpp_debug.pl, have RPerl::Test::my_subroutine() = '} . RPerl::Test::my_subroutine() . "'\n" or croak();
#print STDERR q{in inline_cpp_debug.pl, have $my_object->my_subroutine() = '} . $my_object->my_subroutine() . "'\n" or croak();
