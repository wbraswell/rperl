...
$rperlnamespaces_generated::NONCOMPILED = undef;
...
# DEV NOTE, CORRELATION #rp051: hard-coded list of RPerl data types and data structures [AUTOMATICALLY GENERATED BY script/development/namespaces_regenerate.pl]
# DEV NOTE, CORRELATION #rp054: auto-generated OO property accessors/mutators check the auto-generated RPerl type list for base data types to determine if the entire data structure can be returned by setting ($return_whole = 1)
...
$rperlnamespaces_generated::RPERL = {
    ...
    'arrayref_arrayref_hashref::'             => 1,
    'arrayref_hashref::'                      => 1,
    'arrayref_hashref_hashref::'              => 1,
    'character::'                             => 1,
    ...
    'hashref::'                               => 1,
    'hashref_arrayref::'                      => 1,
    'hashref_arrayref_hashref::'              => 1,
    'hashref_hashref::'                       => 1,
    'hashref_hashref_hashref::'               => 1,
    'integer::'                               => 1,
    'integer_arrayref::'                      => 1,
    'integer_arrayref_arrayref::'             => 1,
    'integer_arrayref_arrayref_arrayref::'    => 1,
    'integer_arrayref_arrayref_hashref::'     => 1,
    'integer_arrayref_hashref::'              => 1,
    'integer_arrayref_hashref_hashref::'      => 1,
    'integer_hashref::'                       => 1,
    'integer_hashref_arrayref_hashref::'      => 1,
    'integer_hashref_hashref::'               => 1,
    'integer_hashref_hashref_hashref::'       => 1,
    'method::'                                => 1,
    'number::'                                => 1,
    'number_arrayref::'                       => 1,
    'number_arrayref_arrayref::'              => 1,
    'number_arrayref_arrayref_arrayref::'     => 1,
    'number_arrayref_arrayref_hashref::'      => 1,
    'number_arrayref_hashref::'               => 1,
    'number_arrayref_hashref_hashref::'       => 1,
    'number_hashref::'                        => 1,
    'number_hashref_arrayref_hashref::'       => 1,
    'number_hashref_hashref::'                => 1,
    'number_hashref_hashref_hashref::'        => 1,
    'object::'                                => 1,
    'object_arrayref::'                       => 1,
    'object_hashref::'                        => 1,
    ...
    'scalartype_arrayref_arrayref_hashref::'  => 1,
    'scalartype_arrayref_hashref_hashref::'   => 1,
    'scalartype_hashref::'                    => 1,
    'scalartype_hashref_arrayref_hashref::'   => 1,
    'scalartype_hashref_hashref::'            => 1,
    'scalartype_hashref_hashref_hashref::'    => 1,
    'sse_number_pair::'                       => 1,
    'string::'                                => 1,
    'string_arrayref::'                       => 1,
    'string_arrayref_arrayref::'              => 1,
    'string_arrayref_arrayref_arrayref::'     => 1,
    'string_arrayref_arrayref_hashref::'      => 1,
    'string_arrayref_hashref::'               => 1,
    'string_arrayref_hashref_hashref::'       => 1,
    'string_hashref::'                        => 1,
    'string_hashref_arrayref_hashref::'       => 1,
    'string_hashref_hashref::'                => 1,
    'string_hashref_hashref_hashref::'        => 1,
    'unknown::'                               => 1,
    'unsigned_integer::'                      => 1,
    'void::'                                  => 1
};
