...
# START HERE AFTER: create tests for class Exporter to subclass-in-same-file using new syntax BEGIN { Class->import(NOT EMPTY); } for parent include (with commented code lines above) 
# START HERE AFTER: create tests for class Exporter to subclass-in-same-file using new syntax BEGIN { Class->import(NOT EMPTY); } for parent include (with commented code lines above) 
# START HERE AFTER: create tests for class Exporter to subclass-in-same-file using new syntax BEGIN { Class->import(NOT EMPTY); } for parent include (with commented code lines above) 

# START HERE AFTER AFTER: create tests for Exporter, multiple packages in one file, using new syntax 'BEGIN { Package->import(NOT EMPTY); }' as Include production
# START HERE AFTER AFTER: create tests for Exporter, multiple packages in one file, using new syntax 'BEGIN { Package->import(NOT EMPTY); }' as Include production
# START HERE AFTER AFTER: create tests for Exporter, multiple packages in one file, using new syntax 'BEGIN { Package->import(NOT EMPTY); }' as Include production
