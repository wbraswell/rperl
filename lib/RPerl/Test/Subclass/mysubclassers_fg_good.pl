...
my RPerl::Test::Subclass::MySubclassersFG_Good $my_f = RPerl::Test::Subclass::MySubclasserF_Good->new();
my RPerl::Test::Subclass::MySubclassersFG_Good $my_g = RPerl::Test::Subclass::MySubclasserG_Good->new();
...
# START HERE AFTER: create tests for class Exporter to subclass-in-same-file using new syntax:  BEGIN { Class->import(); }
# START HERE AFTER: create tests for class Exporter to subclass-in-same-file using new syntax:  BEGIN { Class->import(); }
# START HERE AFTER: create tests for class Exporter to subclass-in-same-file using new syntax:  BEGIN { Class->import(); }
