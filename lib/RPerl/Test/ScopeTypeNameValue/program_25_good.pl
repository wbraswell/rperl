...
# <<< RUN_SUCCESS: "$qui::bat = my undefined $TYPED_qui__bat = undef;" >>>
...
package main::qui; my $bat = 'hal'; $bat = my string $TYPED_bat = 'happy'; $bat = 'howdy!'; package main; print scope_type_name_value($foo) . "\n" . scope_type_name_value($bar) . "\n" . scope_type_name_value($main::qui::bat) . "\n";