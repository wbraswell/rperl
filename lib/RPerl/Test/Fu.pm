...
our unknown $quux_croak = sub {
    ...
    #    croak 2, 3;               # GOOD OperatorVoid_116; program_28*
    #    croak 2, 3, 5, 7;         # GOOD OperatorVoid_116; program_29*
    #    croak (2, 3);             # BAD  OperatorVoid_116, parser, parens as subexpression cannot be list with commas; program_28_bad_00.pl
    #    croak (2, 3, 5, 7);       # BAD  OperatorVoid_116, parser, parens as subexpression cannot be list with commas; program_29_bad_00.pl
    #    croak(2, 3);              # GOOD OperatorVoid_115, parens as args; program_30*
    #    croak(2, 3, 5, 7);        # GOOD OperatorVoid_115, parens as args; program_31*
...
our unknown $quux_return = sub {
    ...
    #    return 2, 3;               # BAD  OperatorVoid_116, generator; program_24_bad_01.pl
    #    return 2, 3, 5, 7;         # BAD  OperatorVoid_116, generator; program_24_bad_02.pl
    #    return(2, 3);              # BAD  OperatorVoid_115, generator, parens as args; program_24_bad_03.pl
    #    return(2, 3, 5, 7);        # BAD  OperatorVoid_115, generator, parens as args; program_24_bad_04.pl
    #    return (2, 3);             # BAD  OperatorVoid_116, parser, parens as subexpression cannot be list with commas; program_24_bad_05.pl
    #    return (2, 3, 5, 7);       # BAD  OperatorVoid_116, parser, parens as subexpression cannot be list with commas; program_24_bad_06.pl
    ...
    #    return(%{{a => 2}});                       # BAD  OperatorVoid_115, generator, parens as args; program_41_bad_01.pl
    #    return((%{{a => 2}}));                     # BAD  OperatorVoid_115, generator, outer parens as args, inner parens as subexpression; program_41_bad_02.pl
    #    return(((%{{a => 2}})));                   # BAD  OperatorVoid_115, generator, outer parens as args, inner parens as subexpressions; program_41_bad_03.pl
    #    return((((%{{a => 2}}))));                 # BAD  OperatorVoid_115, generator, outer parens as args, inner parens as subexpressions; program_41_bad_04.pl 
    #    return %{{a => 2}};                        # BAD  OperatorVoid_116, generator; program_41_bad_05.pl
    #    return (%{{a => 2}});                      # BAD  OperatorVoid_116, generator, parens as subexpression; program_41_bad_06.pl
    #    return ((%{{a => 2}}));                    # BAD  OperatorVoid_116, generator, parens as subexpressions; program_41_bad_07.pl
    #    return (((%{{a => 2}})));                  # BAD  OperatorVoid_116, generator, parens as subexpressions; program_41_bad_08.pl
};
