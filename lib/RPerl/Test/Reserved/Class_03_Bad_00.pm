...
# [[[ HEADER ]]]
use RPerl;
package RPerl::Test::Reserved::Class_03_Bad_00;
use strict;
use warnings;
...
sub _foo_subroutine {
    ...
    print 'in RPerl::Test::Reserved::Class_03_Bad_00::_foo_subroutine(), received $_Foo_argument = ', $_Foo_argument, "\n";
...
sub _foo_method {
    ...
    ( my RPerl::Test::Reserved::Class_03_Bad_00 $self, my integer $_Foo_argument ) = @ARG;

    print 'in RPerl::Test::Reserved::Class_03_Bad_00::_foo_method(), received $_Foo_argument = ', $_Foo_argument, "\n";
    print 'in RPerl::Test::Reserved::Class_03_Bad_00::_foo_method(), have $self->{foo_property} = ', q{'}, $self->{foo_property}, q{'}, "\n";
