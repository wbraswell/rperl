...
my string $key_valid     = 'key_0';
my string $key_not_valid = 'key_X';
my boolean $key_does_exist     = exists $foo->{$key_valid};
my boolean $key_does_not_exist = exists $foo->{$key_not_valid};
