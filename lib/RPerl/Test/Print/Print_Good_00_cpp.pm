...
our void__method $cpp_load = sub {
    my $need_load_cpp = 0;
    if (    ( exists $main::{'RPerl__Test__Print_00__ops'} )
        and ( defined &{ $main::{'RPerl__Test__Print_00__ops'} } ) )
    {
#        RPerl::diag "in Print_00_cpp::cpp_load, RPerl__Test__Print_00__ops() exists & defined\n";
#        RPerl::diag q{in Print_00_cpp::cpp_load, have RPerl__Test__Print_00__ops() retval = '} . main::RPerl__Test__Print_00__ops() . "'\n";
        if ( main::RPerl__Test__Print_00__ops() ne 'CPP' ) {
            $need_load_cpp = 1;
        }
    }
    else {
#        RPerl::diag "in Print_00_cpp::cpp_load, RPerl__Test__Print_00__ops() does not exist or undefined\n";
        $need_load_cpp = 1;
    }
