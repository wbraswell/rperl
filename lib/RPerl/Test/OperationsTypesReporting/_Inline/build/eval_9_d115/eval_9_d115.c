...
XS_EUPXS(XS_main_RPerl_object_property_init)
{
	...
	SV *	initee = ST(0)
;
#line 114 "eval_9_d115.xs"
	I32 *	__temp_markstack_ptr;
#line 348 "eval_9_d115.c"
#line 116 "eval_9_d115.xs"
...
XS_EUPXS(XS_main_RPerl__HelperFunctions__ops); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_main_RPerl__HelperFunctions__ops)
{
    dVAR; dXSARGS;
    if (items != 0)
       croak_xs_usage(cv,  "");
	...
	RETVAL = RPerl__HelperFunctions__ops();
	ST(0) = RETVAL;
	sv_2mortal(ST(0));
    }
    XSRETURN(1);
...
XS_EXTERNAL(boot_eval_9_d115)
{
    ...
    XS_VERSION_BOOTCHECK;
        ...
        newXS("main::RPerl__HelperFunctions__ops", XS_main_RPerl__HelperFunctions__ops, file);
#if (PERL_REVISION == 5 && PERL_VERSION >= 9)
  if (PL_unitcheckav)
