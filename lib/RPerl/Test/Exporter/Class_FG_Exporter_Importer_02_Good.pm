...
package RPerl::Test::Exporter::Class_FG_Exporter_Importer_02_Good;
use strict;
use warnings;
...
sub multiply_bax_FG {
    ...
    ( my RPerl::Test::Exporter::Class_FG_Exporter_Importer_02_Good $self, my integer $multiplier ) = @ARG;
...
use RPerl;
package RPerl::Test::Exporter::Class_F_Exporter_Importer_02_Good;
use strict;
use warnings;
our $VERSION = 0.001_000;

# [[[ OO INHERITANCE ]]]
use parent -norequire, qw(RPerl::Test::Exporter::Class_FG_Exporter_Importer_02_Good);
INIT { RPerl::Test::Exporter::Class_FG_Exporter_Importer_02_Good->import(qw(multiply_return_FG)); }
...
sub multiply_bax_F {
    { my void::method $RETURN_TYPE };
    ( my RPerl::Test::Exporter::Class_F_Exporter_Importer_02_Good $self, my integer $multiplier ) = @ARG;
    $self->{bax} = $self->{bax} * $multiplier;
    return;
}
...
use RPerl;
package RPerl::Test::Exporter::Class_G_Importer_02_Good;
use strict;
use warnings;
our $VERSION = 0.001_000;

# [[[ OO INHERITANCE ]]]
use parent -norequire, qw(RPerl::Test::Exporter::Class_F_Exporter_Importer_02_Good);
INIT { RPerl::Test::Exporter::Class_F_Exporter_Importer_02_Good->import(); }
...
sub multiply_bax_G {
    { my void::method $RETURN_TYPE };
    ( my RPerl::Test::Exporter::Class_G_Importer_02_Good $self, my integer $multiplier ) = @ARG;
    $self->{bax} = $self->{bax} * $multiplier;
    return;
}
