...
# [[[ HEADER ]]]
use RPerl;
package RPerl::Test::Exporter::Class_C_Exporter_20_Bad_10;
use strict;
use warnings;
...
our @EXPORT = qw(&exported $not_exported_scalar @exported_array %exported_hash *exported_typeglob);
...
&{*exported_typeglob};  # AVOID ERROR: Name "RPerl::Test::Exporter::Class_C_Exporter_20_Bad_10::exported_typeglob" used only once: possible typo
...
sub exported {
    ...
    ( my integer $arg ) = @ARG;
    print 'in Class_C_Exporter_20_Bad_10::exported(), received $arg = ', $arg, "\n";
    return ($arg * 120);
}
...
sub not_exported {
    { my integer $RETURN_TYPE };
    ( my integer $arg ) = @ARG;
    print 'in Class_C_Exporter_20_Bad_10::not_exported(), received $arg = ', $arg, "\n";
    return ($arg * 420);
}
