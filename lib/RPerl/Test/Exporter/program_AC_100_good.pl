...
# [[[ PREPROCESSOR ]]]
# <<< EXECUTE_SUCCESS: 'in Class_AC_Exporter_00_Good::exported_ok(), received $arg = 17' >>>
# <<< EXECUTE_SUCCESS: 'after exported_ok(17), received $exported_ok_retval = 714' >>>
# <<< EXECUTE_SUCCESS: 'in Class_AC_Exporter_00_Good::exported(), received $arg = 17' >>>
...
# [[[ INCLUDES ]]]
use RPerl::Test::Exporter::Class_AC_Exporter_00_Good qw(exported_ok);
