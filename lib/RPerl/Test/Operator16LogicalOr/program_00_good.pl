...
# <<< EXECUTE_SUCCESS: "have $bbb_boolean = 1" >>>
# <<< EXECUTE_SUCCESS: "have $ccc_boolean = 1" >>>
# <<< EXECUTE_SUCCESS: "have $ddd_boolean = 1" >>>
# <<< EXECUTE_SUCCESS: "have $aaa_integer = 22" >>>
# <<< EXECUTE_SUCCESS: "have $bbb_integer = 9_123" >>>
# <<< EXECUTE_SUCCESS: "have $aaa_number  = -22.3" >>>
# <<< EXECUTE_SUCCESS: "have $bbb_number  = 9_123.45" >>>
# <<< EXECUTE_SUCCESS: "have $aaa_string  = doody" >>>
# <<< EXECUTE_SUCCESS: "have $bbb_string  = howdy" >>>
...
my boolean $aaa_boolean = 0 || 0;
my boolean $bbb_boolean = 0 || 1;
my boolean $ccc_boolean = 1 || 0;
my boolean $ddd_boolean = 1 || 1;

my integer $aaa_integer = 22 || $foo_integer;
my integer $bbb_integer = $foo_integer || 22;

my number  $aaa_number = -22.3 || $foo_number;
my number  $bbb_number = $foo_number || -22.3;

my string  $aaa_string = 'doody' || $foo_string;
my string  $bbb_string = $foo_string || 'doody';
