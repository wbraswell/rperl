...
# <<< EXECUTE_SUCCESS: "have $aaa_boolean = >>><<<" >>>
# <<< EXECUTE_SUCCESS: "have $bbb_boolean = >>>1<<<" >>>
# <<< EXECUTE_SUCCESS: "have $ccc_boolean = >>>1<<<" >>>
# <<< EXECUTE_SUCCESS: "have $ddd_boolean = >>><<<" >>>
# <<< EXECUTE_SUCCESS: "have $aaa_integer = >>><<<" >>>
# <<< EXECUTE_SUCCESS: "have $bbb_integer = >>><<<" >>>
# <<< EXECUTE_SUCCESS: "have $ccc_integer = >>>1<<<" >>>
# <<< EXECUTE_SUCCESS: "have $ddd_integer = >>>1<<<" >>>
# <<< EXECUTE_SUCCESS: "have $aaa_number  = >>><<<" >>>
# <<< EXECUTE_SUCCESS: "have $bbb_number  = >>><<<" >>>
# <<< EXECUTE_SUCCESS: "have $ccc_number  = >>>1<<<" >>>
# <<< EXECUTE_SUCCESS: "have $ddd_number  = >>>1<<<" >>>
# <<< EXECUTE_SUCCESS: "have $aaa_string  = >>><<<" >>>
# <<< EXECUTE_SUCCESS: "have $bbb_string  = >>><<<" >>>
# <<< EXECUTE_SUCCESS: "have $ccc_string  = >>>1<<<" >>>
# <<< EXECUTE_SUCCESS: "have $ddd_string  = >>>1<<<" >>>
