...
#    RPerl::diag( 'in Operator::Bitwise::And->ast_to_rperl__generate(), received $self = ' . "\n" . RPerl::Parser::rperl_ast__dump($self) . "\n" );

    my string $self_class = ref $self;
    if ( $self_class eq 'Operator_120' ) {  # Operator -> SubExpression OP13_BITWISE_AND SubExpression
        ...
        die RPerl::Parser::rperl_rule__replace(
            'ERROR ECOGEASRP000, CODE GENERATOR, ABSTRACT SYNTAX TO RPERL: Grammar rule '
                . $self_class
                . ' found where Operator_120 expected, dying' )
            . "\n";
    }
...
sub ast_to_cpp__generate__CPPOPS_PERLTYPES {
    ...
    my string_hashref $cpp_source_group
        = { CPP =>
            q{// <<< RP::O::E::O::B::A __DUMMY_SOURCE_CODE CPPOPS_PERLTYPES >>>}
            . "\n" };
