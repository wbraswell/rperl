...
#     SUPPORTED:  reverse LIST

# [[[ HEADER ]]]
package RPerl::Operation::Expression::Operator::Named::Reverse;
use strict;
use warnings;
...
# [[[ CONSTANTS ]]]
use constant NAME          => my string $TYPED_NAME           = 'reverse';
...
#    RPerl::diag( 'in Operator::Named::Reverse->ast_to_rperl__generate(), received $self = ' . "\n" . RPerl::Parser::rperl_ast__dump($self) . "\n" );
...
our string_hashref::method $ast_to_cpp__generate__CPPOPS_PERLTYPES = sub {
    ...
    my string_hashref $cpp_source_group
        = { CPP =>
            q{// <<< RP::O::E::O::N::Re __DUMMY_SOURCE_CODE CPPOPS_PERLTYPES >>>}
            . "\n" };
...
our string_hashref::method $ast_to_cpp__generate__CPPOPS_CPPTYPES = sub {
    ...
    my string_hashref $cpp_source_group
        = { CPP =>
            q{// <<< RP::O::E::O::N::Re __DUMMY_SOURCE_CODE CPPOPS_CPPTYPES >>>}
            . "\n" };
