...
# NOT SUPPORTED:  sort SUBNAME LIST
# NOT SUPPORTED:  sort BLOCK LIST
#     SUPPORTED:  sort LIST

# [[[ HEADER ]]]
package RPerl::Operation::Expression::Operator::Named::Sort;
use strict;
use warnings;
...
# [[[ CONSTANTS ]]]
use constant NAME          => my string $TYPED_NAME           = 'sort';
...
#    RPerl::diag( 'in Operator::Named::Sort->ast_to_rperl__generate(), received $self = ' . "\n" . RPerl::Parser::rperl_ast__dump($self) . "\n" );
#    RPerl::diag( 'in Operator::Named::Sort->ast_to_rperl__generate(), received $operator_named = ' . "\n" . RPerl::Parser::rperl_ast__dump($operator_named) . "\n" );
    ...
    if ( $operator_named_class eq 'Operation_79' ) { # Operation -> OP01_NAMED_SCOLON
        die RPerl::Parser::rperl_rule__replace(
            'ERROR ECVGEASRP16, CODE GENERATOR, ABSTRACT SYNTAX TO RPERL: named operator '
...
our string_hashref::method $ast_to_cpp__generate__CPPOPS_PERLTYPES = sub {
    ...
    my string_hashref $cpp_source_group
        = { CPP =>
            q{// <<< RP::O::E::O::N::So __DUMMY_SOURCE_CODE CPPOPS_PERLTYPES >>>}
            . "\n" };
...
our string_hashref::method $ast_to_cpp__generate__CPPOPS_CPPTYPES = sub {
    ...
    my string_hashref $cpp_source_group
        = { CPP =>
            q{// <<< RP::O::E::O::N::So __DUMMY_SOURCE_CODE CPPOPS_CPPTYPES >>>}
            . "\n" };
