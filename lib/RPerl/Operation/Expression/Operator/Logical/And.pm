...
our string_hashref::method $ast_to_rperl__generate = sub {
    ...
    if (( $self_class eq 'Operator_106' )       # Operator -> SubExpression OP15_LOGICAL_AND SubExpression
        or ( $self_class eq 'Operator_111' )    # Operator -> SubExpression OP23_LOGICAL_AND SubExpression
        )
    {
