...
#    RPerl::diag( 'in Operator::Logical::Negation->ast_to_rperl__generate(), received $self = ' . "\n" . RPerl::Parser::rperl_ast__dump($self) . "\n" );
    ...
    if (( $self_class eq 'Operator_92' ) # Operator -> OP05_LOGICAL_NEG SubExpression
        or ( $self_class eq 'Operator_110' ) # Operator -> OP22_LOGICAL_NEG SubExpression
        )
    {
        ...
        die RPerl::Parser::rperl_rule__replace(
            'ERROR ECOGEASRP00, CODE GENERATOR, ABSTRACT SYNTAX TO RPERL: Grammar rule '
                . $self_class
                . ' found where Operator_92 or Operator_110 expected, dying' )
            . "\n";
    }
