...
#     SUPPORTED:  defined EXPR
# NOT SUPPORTED:  defined

# [[[ HEADER ]]]
package RPerl::Operation::Expression::Operator::NamedUnary::Defined;
use strict;
use warnings;
...
# [[[ CONSTANTS ]]]
use constant NAME          => my string $TYPED_NAME           = 'defined';
...
#    RPerl::diag( 'in Operator::NamedUnary::Defined->ast_to_rperl__generate(), received $self = ' . "\n" . RPerl::Parser::rperl_ast__dump($self) . "\n" );
#    RPerl::diag( 'in Operator::NamedUnary::Defined->ast_to_rperl__generate(), received $operator_named = ' . "\n" . RPerl::Parser::rperl_ast__dump($operator_named) . "\n" );
    ...
    if ( $operator_named_class eq 'Operation_80' ) { # Operation -> OP10_NAMED_UNARY_SCOLON
        ...
        die RPerl::Parser::rperl_rule__replace(
            'ERROR ECVGEASRP00, CODE GENERATOR, ABSTRACT SYNTAX TO RPERL: grammar rule '
                ...
                . ' found where Operation_80, Operator_83, Operator_84, or OperatorVoid_121 expected, dying'
        ) . "\n";
    }
...
our string_hashref::method $ast_to_cpp__generate__CPPOPS_PERLTYPES = sub {
    ...
    my string_hashref $cpp_source_group
        = { CPP =>
            q{// <<< RP::O::E::O::NU::D __DUMMY_SOURCE_CODE CPPOPS_PERLTYPES >>>}
            . "\n" };
...
our string_hashref::method $ast_to_cpp__generate__CPPOPS_CPPTYPES = sub {
    ...
    my string_hashref $cpp_source_group
        = { CPP =>
            q{// <<< RP::O::E::O::NU::D __DUMMY_SOURCE_CODE CPPOPS_CPPTYPES >>>}
            . "\n" };
