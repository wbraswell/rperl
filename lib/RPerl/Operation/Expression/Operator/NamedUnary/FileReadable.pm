...
our string_hashref::method $ast_to_cpp__generate__CPPOPS_PERLTYPES = sub {
    ...
    my string_hashref $cpp_source_group = { CPP => q{// <<< RP::O::E::O::NU::FRead __DUMMY_SOURCE_CODE CPPOPS_PERLTYPES >>>} . "\n" };
...
our string_hashref::method $ast_to_cpp__generate__CPPOPS_CPPTYPES = sub {
    ( my object $self, my string_hashref $modes) = @_;
    my string_hashref $cpp_source_group = { CPP => q{// <<< RP::O::E::O::NU::FRead __DUMMY_SOURCE_CODE CPPOPS_CPPTYPES >>>} . "\n" };
