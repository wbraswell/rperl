...
# [[[ HEADER ]]]
package RPerl::Operation::Expression::Operator::NamedUnary::FileText;
use strict;
use warnings;
...
#    RPerl::diag( 'in Operator::NamedUnary::FileText->ast_to_rperl__generate(), received $self = ' . "\n" . RPerl::Parser::rperl_ast__dump($self) . "\n" );
#    RPerl::diag( 'in Operator::NamedUnary::FileText->ast_to_rperl__generate(), received $operator_named = ' . "\n" . RPerl::Parser::rperl_ast__dump($operator_named) . "\n" );
...
sub ast_to_cpp__generate__CPPOPS_PERLTYPES {
    ...
    my string_hashref $cpp_source_group = { CPP => q{// <<< RP::O::E::O::NU::FT __DUMMY_SOURCE_CODE CPPOPS_PERLTYPES >>>} . "\n" };
...
sub ast_to_cpp__generate__CPPOPS_CPPTYPES {
    { my string_hashref::method $RETURN_TYPE };
    ( my object $self, my string_hashref $modes) = @ARG;
    my string_hashref $cpp_source_group = { CPP => q{// <<< RP::O::E::O::NU::FT __DUMMY_SOURCE_CODE CPPOPS_CPPTYPES >>>} . "\n" };
