...
#     SUPPORTED:  chdir EXPR
# NOT SUPPORTED:  chdir FILEHANDLE
# NOT SUPPORTED:  chdir DIRHANDLE
#     SUPPORTED:  chdir
...
# [[[ CONSTANTS ]]]
use constant NAME          => my string $TYPED_NAME           = 'chdir';
...
#    RPerl::diag( 'in Operator::NamedUnary::ChangeDirectory->ast_to_rperl__generate(), received $self = ' . "\n" . RPerl::Parser::rperl_ast__dump($self) . "\n" );
#    RPerl::diag( 'in Operator::NamedUnary::ChangeDirectory->ast_to_rperl__generate(), received $operator_named = ' . "\n" . RPerl::Parser::rperl_ast__dump($operator_named) . "\n" );
