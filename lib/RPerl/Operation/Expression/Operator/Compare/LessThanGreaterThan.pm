...
#    RPerl::diag( 'in Operator::Compare::LessThanGreaterThan->ast_to_rperl__generate(), received $self = ' . "\n" . RPerl::Parser::rperl_ast__dump($self) . "\n" );

    my string $self_class = ref $self;
    if ( $self_class eq 'Operator_118' ) {  # Operator -> SubExpression OP11_COMPARE_LT_GT SubExpression
        ...
        die RPerl::Parser::rperl_rule__replace(
            'ERROR ECOGEASRP000, CODE GENERATOR, ABSTRACT SYNTAX TO RPERL: Grammar rule '
                . $self_class
                . ' found where Operator_118 expected, dying' )
            . "\n";
    }
...
sub ast_to_cpp__generate__CPPOPS_PERLTYPES {
    ...
    my string_hashref $cpp_source_group
        = {
        CPP => q{// <<< RP::O::E::O::C::LTGT __DUMMY_SOURCE_CODE CPPOPS_PERLTYPES >>>}
            . "\n"
        };
...
#    RPerl::diag( 'in Operator::Compare::LessThanGreaterThan->ast_to_cpp__generate__CPPOPS_CPPTYPES(), received $self = ' . "\n" . RPerl::Parser::rperl_ast__dump($self) . "\n" );
