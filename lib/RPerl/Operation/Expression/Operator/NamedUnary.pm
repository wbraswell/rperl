...
#    RPerl::diag( 'in Operator::NamedUnary->ast_to_rperl__generate(), received $self = ' . "\n" . RPerl::Parser::rperl_ast__dump($self) . "\n" );
    ...
    if ( $self_class eq 'Operator_94' ) {  # Operator -> OP10_NAMED_UNARY SubExpression
    ...
    elsif ( $self_class eq 'Operator_95' ) {  # Operator -> OP10_NAMED_UNARY
...
our string_hashref_method $ast_to_cpp__generate__CPPOPS_CPPTYPES = sub {
    ...
    my string_hashref $cpp_source_group
        = {
        CPP => q{// <<< RP::O::E::O::NU __DUMMY_SOURCE_CODE CPPOPS_CPPTYPES >>>}
            . "\n"
        };
