# [[[ HEADER ]]]
package RPerl::Operation::Expression::Operator::Math::MultiplyDivideModulo;
use strict;
use warnings;
...
#    RPerl::diag( 'in Operator::Math::MultiplyDivideModulo->ast_to_rperl__generate(), received $self = ' . "\n" . RPerl::Parser::rperl_ast__dump($self) . "\n" );
    ...
    if ( $self_class eq 'Operator_92' ) {  # Operator -> SubExpression OP07_MATH_MULT_DIV_MOD SubExpression
