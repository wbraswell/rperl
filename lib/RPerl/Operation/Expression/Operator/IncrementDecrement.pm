...
#    RPerl::diag( 'in Operator::IncrementDecrement->ast_to_rperl__generate(), received $self = ' . "\n" . RPerl::Parser::rperl_ast__dump($self) . "\n" );
    ...
    if ( $self_class eq 'Operator_88' ) {  # Operator -> OP03_MATH_INC_DEC Variable
    ...
    elsif ( $self_class eq 'Operator_89' ) {  # Operator -> Variable OP03_MATH_INC_DEC
        ...
        die RPerl::Parser::rperl_rule__replace(
            'ERROR ECOGEASRP00, CODE GENERATOR, ABSTRACT SYNTAX TO RPERL: Grammar rule '
                . $self_class
                . ' found where Operator_88 or Operator_89 expected, dying' )
            . "\n";
    }
