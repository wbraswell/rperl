...
#    die RPerl::Parser::rperl_rule__replace( 'ERROR ECOGEASCP0xe, CODE GENERATOR, ABSTRACT SYNTAX TO C++: array dereference not supported in CPPOPS_CPPTYPES mode, dying' ) . "\n";
    return $cpp_source_group;
}
