...
our string_hashref_method $ast_to_rperl__generate = sub {
    ...
    my string_hashref $rperl_source_group = { PMC => q{# <<< RP::O::E::SE::HD __DUMMY_SOURCE_CODE PERLOPS_PERLTYPES >>>}
            . "\n" };
...
our string_hashref_method $ast_to_cpp__generate__CPPOPS_PERLTYPES = sub {
    ...
    my string_hashref $cpp_source_group
        = { CPP => q{// <<< RP::O::E::SE::HD __DUMMY_SOURCE_CODE CPPOPS_PERLTYPES >>>}
            . "\n" };
...
our string_hashref_method $ast_to_cpp__generate__CPPOPS_CPPTYPES = sub {
    ( my object $self, my string_hashref $modes) = @_;
    my string_hashref $cpp_source_group
        = { CPP => q{// <<< RP::O::E::SE::HD __DUMMY_SOURCE_CODE CPPOPS_CPPTYPES >>>}
            . "\n" };
