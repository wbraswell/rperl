...
sub ast_to_rperl__generate {
    ...
    if ( $self_class eq 'VariableRetrieval_180' ) {    # VariableRetrieval -> OP02_ARRAY_THINARROW SubExpression ']'
    ...
    elsif ( $self_class eq 'VariableRetrieval_181' ) {    # VariableRetrieval -> OP02_HASH_THINARROW SubExpression '}'
    ...
    elsif ( $self_class eq 'VariableRetrieval_182' ) {    # VariableRetrieval -> OP02_HASH_THINARROW WORD '}'
        my string $arrow_left_brace = $self->{children}->[0];
