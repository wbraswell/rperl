...
sub ast_to_rperl__generate {
    ...
    if ( $self_class eq 'OperatorVoid_129' ) {    # OperatorVoid -> OP01_PRINT OPTIONAL-31 ListElements ';'
...
# RPerl::InputOutput::Stderr & RPerl::InputOutput::Stdout
    ...
    elsif ( $self_class eq 'OperatorVoid_130' ) {    # OperatorVoid -> OP01_PRINT FHREF_SYMBOL_BRACES ListElements ';'
        my string $print               = $self->{children}->[0];
        ...
        die RPerl::Parser::rperl_rule__replace( 'ERROR ECOGEASRP00, CODE GENERATOR, ABSTRACT SYNTAX TO RPERL: Grammar rule '
                . $self_class
                . ' found where OperatorVoid_129 or OperatorVoid_130 expected, dying' )
            . "\n";
    }
