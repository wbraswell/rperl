...
our object__method $ppi_to_rperl__translate = sub {
    ...
    $node_translated
        = { STUB_AST_OBJECT => 'CREATED BY RPerl::Operation::Statement' };
...
our string__method $rperl_to_cpp__generate__CPPOPS_PERLTYPES = sub {
    ...
    $self_generated
        .= 'STUB PERL CODE STRING, CREATED BY RPerl::Operation::Statement';
...
our string__method $rperl_to_cpp__generate__CPPOPS_CPPTYPES = sub {
    ...
    my string $self_generated = q{};
    $self_generated
        .= 'STUB CPP CODE STRING, CREATED BY RPerl::Operation::Statement';
    return ($self_generated);
};
