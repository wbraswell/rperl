// NEED UPDATE, CORRELATION #rp130: all changes to this file must also be made in lib/RPerl/Support/MongoDB.h !!!
...
# ifdef __PERL__TYPES
SV* RPerl__Support__MongoDBStandAlone__MODE_ID() { return(newSViv(1)); }  // CPPOPS_PERLTYPES is 1
# elif defined __CPP__TYPES
int RPerl__Support__MongoDBStandAlone__MODE_ID() { return 2; }  // CPPOPS_CPPTYPES is 2
# else
