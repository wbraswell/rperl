...
# [[[ INHERITANCE TESTING ]]]
our void__method $inherited__Inefficient = sub { (my object $self, my string $person) = @_;  RPerl::diag "in Perl Inefficient->inherited__Inefficient(), have \$self = '$self' and \$person = '$person', FLUFFY\n"; };
our void__method $inherited = sub { (my object $self, my string $person) = @_;  RPerl::diag "in Perl Inefficient->inherited(), have \$self = '$self' and \$person = '$person', INCOMPATIBLE\n"; };
our string $uninherited__Inefficient = sub { (my string $person) = @_;  RPerl::diag "in Perl Inefficient::uninherited__Inefficient(), \$person = '$person', MESSY\n";  return "Perl Inefficient::uninherited__Inefficient() RULES!"; };
#our string $uninherited = sub { (my string $person) = @_;  RPerl::diag "in Perl Inefficient::uninherited(), \$person = '$person', TRICKS\n";  return "Perl Inefficient::uninherited() ROCKS!"; };
