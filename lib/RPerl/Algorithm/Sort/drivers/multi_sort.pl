...
my scalar_linkedlist_ref $data = scalar_linkedlist_ref->new_from_array_ref([21, 12, 31, 13, 42, 2012, 5555, 1.21, 33.3, 9999, -15, 0]);
print "in multi_sort.pl, have \$data =\n" . RPerl::DUMPER($data) . "\n" if $RPerl::DEBUG;
...
my $data2_sorted = RPerl::Algorithm::Sort::Merge::mergesort_linkedlist($data2->{head});
