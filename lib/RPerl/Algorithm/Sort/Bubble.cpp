...
////;
{
//	if (RPerl__DEBUG2) { printf("in sort(), top of subroutine, have this->data = %d\n", this->data); }

////	$self->{data} = bubblesort($self->{data});
	this->data = bubblesort(this->data);

//	if (RPerl__DEBUG2) { printf("in sort(), bottom of subroutine, have this->data = %d\n", this->data); }
////};
}
...
//	if (RPerl__DEBUG2) { printf("in bubblesort(), after variable init, have swap = %d\n", swap); }
...
////#		print "in bubblesort(), top of while loop\n" if $RPerl::DEBUG;
//		if (RPerl__DEBUG2) { printf("in bubblesort(), top of while() loop\n"); }
//		if (RPerl__DEBUG3) { printf("in bubblesort(), top of while() loop, have data = %d\n", data); }
//		if (RPerl__DEBUG) { printf("in bubblesort(), top of while() loop, have data_i = %d\n", data_i); }
//		if (RPerl__DEBUG) { printf("in bubblesort(), top of while() loop, have data_i_plus_1 = %d\n", data_i_plus_1); }
//		if (RPerl__DEBUG) { printf("in bubblesort(), top of while() loop, have swap = %d\n", swap); }
...
//			if (RPerl__DEBUG2) { printf("in bubblesort(), top of for() loop, have i = %d\n", i); }
////#			print "in bubblesort(), inside for() loop, have \$data\n" . RPerl::DUMPER($data) . "\n" if $RPerl::DEBUG;
//			if (RPerl__DEBUG3) { printf("in bubblesort(), top of for() loop, have data = %d\n", data); }
//			if (RPerl__DEBUG) { printf("in bubblesort(), top of for() loop, have data_i = %d\n", data_i); }
//			if (RPerl__DEBUG) { printf("in bubblesort(), top of for() loop, have data_i_plus_1 = %d\n", data_i_plus_1); }
//			if (RPerl__DEBUG) { printf("in bubblesort(), top of for() loop, have swap = %d\n", swap); }

////			# compare elements and swap if out-of-order, this is the core sort comparison
////			if ($data->[$i] > $data->[($i + 1)])
//			if (data[i] > data[(i + 1)])  // DE-OPTIMIZE, SHORT-HAND
...
////				$is_sorted = 0;
				is_sorted = 0;
////				$swap = $data->[$i];
//				swap = data[i];  // DE-OPTIMIZE, SHORT-HAND
				swap = data_i;  // OPTIMIZE, LONG-HAND: use data_i
////				$data->[$i] = $data->[($i + 1)];
//				data[i] = data[(i + 1)];  // DE-OPTIMIZE, SHORT-HAND
				data[i] = data_i_plus_1;  // OPTIMIZE, LONG-HAND: use data_i_plus_1
////				$data->[($i + 1)] = $swap;
				data[(i + 1)] = swap;
////			}
			}
//			if (RPerl__DEBUG3) { printf("in bubblesort(), bottom of for() loop, have data = %d\n", data); }
//			if (RPerl__DEBUG) { printf("in bubblesort(), bottom of for() loop, have data_i = %d\n", data_i); }
//			if (RPerl__DEBUG) { printf("in bubblesort(), bottom of for() loop, have data_i_plus_1 = %d\n", data_i_plus_1); }
//			if (RPerl__DEBUG) { printf("in bubblesort(), bottom of for() loop, have swap = %d\n", swap); }
////		}
		}
//		if (RPerl__DEBUG3) { printf("in bubblesort(), bottom of while() loop, have data = %d\n", data); }
//		if (RPerl__DEBUG) { printf("in bubblesort(), bottom of while() loop, have data_i = %d\n", data_i); }
//		if (RPerl__DEBUG) { printf("in bubblesort(), bottom of while() loop, have data_i_plus_1 = %d\n", data_i_plus_1); }
//		if (RPerl__DEBUG) { printf("in bubblesort(), bottom of while() loop, have swap = %d\n", swap); }
////	}
	}

//	if (RPerl__DEBUG3) { printf("in bubblesort(), bottom of subroutine, have data = %d\n", data); }
//	if (RPerl__DEBUG) { printf("in bubblesort(), bottom of subroutine, have data_i = %d\n", data_i); }
//	if (RPerl__DEBUG) { printf("in bubblesort(), bottom of subroutine, have data_i_plus_1 = %d\n", data_i_plus_1); }
//	if (RPerl__DEBUG) {  printf("in bubblesort(), bottom of subroutine, have swap = %d\n", swap); }
