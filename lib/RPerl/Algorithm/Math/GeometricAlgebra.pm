...
our number $inner_product__vector_vector_euclidean = sub {
    ( my number__array_ref $input_vector_1, my number__array_ref $input_vector_2) = @_;
...
#    ::number__array_ref__CHECK($input_vector_2);
    ...
    # bound checking
    ((scalar @{$input_vector_1}) == 4) or croak('Argument vector 1 is not of magnitude 4, croaking');
    ((scalar @{$input_vector_2}) == 4) or croak('Argument vector 2 is not of magnitude 4, croaking');
...
our number__array_ref $inner_product__bivector_vector_euclidean = sub {
    ( my number__array_ref $input_bivector, my number__array_ref $input_vector) = @_;
...
#    ::number__array_ref__CHECK($input_vector);
    ...
    # bound checking
    ((scalar @{$input_bivector}) == 4) or croak('Argument bivector is not of magnitude 4, croaking');
    ((scalar @{$input_vector}) == 4) or croak('Argument vector is not of magnitude 4, croaking');
...
#    RPerl::diag "in PERLOPS_PERLTYPES outer_product__vector_vector_euclidean(), received \$input_vector_2\n" . Dumper($input_vector_2) . "\n";
    ...
    $return_value_number = ($input_bivector->[1] * $input_vector->[3]) + ($input_bivector->[2] * $input_vector->[1]) + ($input_bivector->[3] * $input_vector->[2]);
