...
# export Dumper(), carp(), croak(), confess(), $ERRNO, $EVAL_ERROR, and $CHILD_ERROR to all who call 'use RPerl::Config;'
use Data::Dumper;
use Carp;
use English qw(-no_match_vars);
use Exporter 'import';
our @EXPORT = qw(Dumper carp croak confess $ERRNO $EVAL_ERROR $CHILD_ERROR);
...
# export Dumper(), carp(), croak(), confess(), $ERRNO, $EVAL_ERROR, and $CHILD_ERROR to all who call 'use RPerl;'
use Data::Dumper;
use Carp;
use English qw(-no_match_vars);
use Exporter 'import';
