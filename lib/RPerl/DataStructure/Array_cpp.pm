...
;
	if (defined($RPerl::DataStructure::Array_cpp::CPP_LOADED)) { print STDERR "in Array_cpp::cpp_load(), have \$RPerl::DataStructure::Array_cpp::CPP_LOADED = '" . $RPerl::DataStructure::Array_cpp::CPP_LOADED . "'\n"; }
		else { print STDERR "in Array_cpp::cpp_load(), have \$RPerl::DataStructure::Array_cpp::CPP_LOADED = 'UNDEF'\n"; }
...
1;
EOF
		print STDERR "in Array_cpp::cpp_load(), CPP not yet loaded, about to call eval() on \$eval_string =\n<<< BEGIN EVAL STRING>>>\n" . $eval_string . "<<< END EVAL STRING >>>\n";
	...
	else { print STDERR "in Array_cpp::cpp_load(), CPP already loaded, DOING NOTHING\n"; }
};

our void__method $cpp_link = sub {
;
#	if (defined($RPerl::DataStructure::Array_cpp::CPP_LINKED)) { print STDERR "in Array_cpp::cpp_link(), have \$RPerl::DataStructure::Array_cpp::CPP_LINKED = '" . $RPerl::DataStructure::Array_cpp::CPP_LINKED . "'\n"; }
#		else { print STDERR "in Array_cpp::cpp_link(), have \$RPerl::DataStructure::Array_cpp::CPP_LINKED = 'UNDEF'\n"; }
...
1;
EOF
#		print STDERR "in Array_cpp::cpp_link(), CPP not yet linked, about to call eval() on \$eval_string =\n<<< BEGIN EVAL STRING>>>\n" . $eval_string . "<<< END EVAL STRING >>>\n";

		eval($eval_string);  ## no critic
		die($@) if ($@);
	}
#	else { print STDERR "in Array_cpp::cpp_link(), CPP already linked, DOING NOTHING\n"; }
};
