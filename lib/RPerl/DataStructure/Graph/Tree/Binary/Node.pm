...
;
	print STDERR "in ...Tree::Binary::NodeReference::traverse_breadthfirst_queue(), received \$self = \n" . RPerl::DUMPER($self) . "\n" if $RPerl::DEBUG;
	my @return_value = ();
	my $return_value_tmp;
	my @queue = ();
	...
	print STDERR "in ...Tree::Binary::NodeReference::traverse_breadthfirst_queue(), before while() loop have \@queue = \n" . RPerl::DUMPER(\@queue) . "\n" if $RPerl::DEBUG;
	
	while (scalar(@queue) > 0)
	{
		$node = pop(@queue);
		print STDERR "in ...Tree::Binary::NodeReference::traverse_breadthfirst_queue(), top of while() loop have \$node = \n" . RPerl::DUMPER($node) . "\n" if $RPerl::DEBUG;
	
		$return_value_tmp = &{$callback}($node);
		push(@return_value, $return_value_tmp) if (defined($return_value_tmp));  # do not include undef values
		
		print STDERR "in ...Tree::Binary::NodeReference::traverse_breadthfirst_queue(), inside while() loop, after callback have \@return_value = \n" . RPerl::DUMPER(\@return_value) . "\n" if $RPerl::DEBUG;
		
		unshift(@queue, $node->{left}) if (defined($node->{left}));
		unshift(@queue, $node->{right}) if (defined($node->{right}));
		print STDERR "in ...Tree::Binary::NodeReference::traverse_breadthfirst_queue(), bottom of while() loop, have \@queue = \n" . RPerl::DUMPER(\@queue) . "\n" if $RPerl::DEBUG;
	}
...
;
	print STDERR "in ...Tree::Binary::NodeReference::traverse_depthfirst_preorder(), received \$self = \n" . RPerl::DUMPER($self) . "\n" if $RPerl::DEBUG;
#	print STDERR "in ...Tree::Binary::NodeReference::traverse_depthfirst_preorder(), received \$callback = " . RPerl::DUMPER($callback) . "\n" if $RPerl::DEBUG;
	my @return_value = ();
	...
	push(@return_value, $return_value_tmp) if (defined($return_value_tmp));  # do not include undef values
	print STDERR "in ...Tree::Binary::NodeReference::traverse_depthfirst_preorder(), after callback on \$self have \@return_value = \n" . RPerl::DUMPER(\@return_value) . "\n" if $RPerl::DEBUG;
	...
	print STDERR "in ...Tree::Binary::NodeReference::traverse_depthfirst_preorder(), after (possible recurse on) \$self->{left} have \@return_value = \n" . RPerl::DUMPER(\@return_value) . "\n" if $RPerl::DEBUG;
	...
	print STDERR "in ...Tree::Binary::NodeReference::traverse_depthfirst_preorder(), after (possible recurse on) \$self->{right} have \@return_value = \n" . RPerl::DUMPER(\@return_value) . "\n" if $RPerl::DEBUG;
...
;
#	print STDERR "in ...Tree::Binary::NodeReference::to_nested_array_refs(), received \$self = \n" . RPerl::DUMPER($self) . "\n" if $RPerl::DEBUG;
...
#	print STDERR "in ...Tree::Binary::NodeReference::to_nested_array_refs(), after callback on \$self have \$return_value = \n" . RPerl::DUMPER($return_value) . "\n" if $RPerl::DEBUG;
...
#	print STDERR "in ...Tree::Binary::NodeReference::to_nested_array_refs(), after (possible recurse on) \$self->{left} have \$return_value = \n" . RPerl::DUMPER($return_value) . "\n" if $RPerl::DEBUG;
...
#	print STDERR "in ...Tree::Binary::NodeReference::to_nested_array_refs(), after (possible recurse on) \$self->{right} have \$return_value = \n" . RPerl::DUMPER($return_value) . "\n" if $RPerl::DEBUG;
...
;
#	print STDERR "in ...Tree::Binary::NodeReference::new_from_nested_array_refs(), received \$class = '$class', and \$input =\n" . RPerl::DUMPER($input) . "\n" if $RPerl::DEBUG;
...
#	print STDERR "in ...Tree::Binary::NodeReference::new_from_nested_array_refs(), about to return \$output =\n" . RPerl::DUMPER($output) . "\n" if $RPerl::DEBUG;
