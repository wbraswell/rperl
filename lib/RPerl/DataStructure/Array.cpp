...
//our void $typetest___string__array_ref__in___void__out = sub { (my string__array_ref $people) = @_;  for (my int $i = 0;  $i < @{$people};  $i++) { print "in Perl Array::typetest___string__array_ref__in___void__out(), have person $i = '" . $people->[$i] . "', FOOBAZ\n"; } };
//void typetest___string__array_ref__in___void__out(string__array_ref people) { int i;  for (i = 0;  i < people.size();  ++i) { printf("in C++ CPP_TYPES printf() Array::typetest___string__array_ref__in___void__out(), have person %d = '%s', FOOBAZ\n", i, people[i].c_str()); } }
void typetest___string__array_ref__in___void__out(string__array_ref people) { int i;  for (i = 0;  i < people.size();  ++i) { cout << "in C++ CPP_TYPES cout<< Array::typetest___string__array_ref__in___void__out(), have person " << i << " = '" << people[i] << "', FOOBAZ\n"; } }
string__array_ref typetest___void__in___string__array_ref__out()
{
	printf("in C++ Array::typetest___void__in___string__array_ref__out(), top of subroutine\n");
	...
	for (i = 0;  i < num_people;  ++i)
	{
		...
		printf("in C++ Array::typetest___void__in___string__array_ref__out(), bottom of for() loop, have i = %d, just set another Jeffy!\n", i);
	}

	printf("in C++ Array::typetest___void__in___string__array_ref__out(), bottom of subroutine\n");
