...
#ifndef __CPP__INCLUDED__RPerl__DataStructure__Hash__SubTypes_cpp
#define __CPP__INCLUDED__RPerl__DataStructure__Hash__SubTypes_cpp 0.002_010

#include <RPerl/DataStructure/Hash/SubTypes.h>		// -> NULL (relies on <vector> being included via Inline::CPP's AUTO_INCLUDE config option)

// [[[ TYPE-CHECKING ]]]
// [[[ TYPE-CHECKING ]]]
// [[[ TYPE-CHECKING ]]]

// START HERE: finish converting, identifiers have been converted but not actual data types or algorithms
// START HERE: finish converting, identifiers have been converted but not actual data types or algorithms
// START HERE: finish converting, identifiers have been converted but not actual data types or algorithms
...
// NEED REFACTOR: move stringify routines out of Hash.cpp into here???
