...
//# [[[ TYPE TESTING ]]]
//# [[[ TYPE TESTING ]]]
void typetest___int__hash_ref__in___void__out(int__hash_ref lucky_numbers);  // CPP_TYPES
void typetest___string__hash_ref__in___void__out(string__hash_ref people);  // CPP_TYPES
string__hash_ref typetest___void__in___string__hash_ref__out();  // CPP_TYPES
