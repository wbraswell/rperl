...
#ifndef __CPP__INCLUDED__RPerl__DataType__StringNTYPE_cpp
#define __CPP__INCLUDED__RPerl__DataType__StringNTYPE_cpp 0.003_003

#include <RPerl/DataType/StringNTYPE.h>		// -> NULL (relies on native C type)
